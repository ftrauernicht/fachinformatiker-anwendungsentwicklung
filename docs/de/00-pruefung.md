...
|---|---|---|---|---|
| Einrichten eines IT-gestützten Arbeitsplatzes | 1 | schriftlich | 90 Minuten | 20 % |
| Planen und Umsetzen eines Softwareprojektes | 2 | Projektarbeit mit Dokumentation, dazu Präsentation und Fachgespräch | höchstens 80 Stunden, dazu höchstens 30 Minuten | 50 % |
| Planen eines Softwareproduktes | 2 | schriftlich | 90 Minuten | 10 % |
...
Vier Bedingungen müssen gleichzeitig erfüllt sein:[^3]

1. Das Gesamtergebnis aus Teil 1 und Teil 2 ist mindestens „ausreichend".
2. Das Ergebnis von Teil 2 ist für sich genommen mindestens „ausreichend".
3. Mindestens drei der fünf Prüfungsbereiche von Teil 2 sind mindestens „ausreichend".
4. Kein Prüfungsbereich von Teil 2 ist mit „ungenügend" bewertet.

Zwei Folgerungen daraus, die regelmäßig übersehen werden: Ein sehr gutes Teil-1-Ergebnis kann ein durchgefallenes Teil 2 nicht retten, weil Teil 2 für sich bestehen muss. Und eine einzelne Sechs in einem der 10-Prozent-Bereiche lässt die gesamte Prüfung scheitern, so gut der Rest auch ist.

## Was geprüft wird: die Prüfungskataloge
...
Sie deckt die beiden schriftlichen Fachbereiche von Teil 2 ab, dazu Wirtschafts- und Sozialkunde in Grundzügen:

| Prüfungsbereich | Kapitel hier |
|---|---|
| Planen eines Softwareproduktes | [Softwareentwicklung](04-softwareentwicklung.md), [Datenbanken](03-datenbanken.md), [Diagramme](diagramme/index.md) |
