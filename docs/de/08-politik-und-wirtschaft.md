...
- [Rechtsformen](#rechtsformen)
  - [Was sich 2024 geändert hat](#was-sich-2024-geändert-hat)
- [Marktformen](#marktformen)
- [Elektronische Rechnung](#elektronische-rechnung)
...
Die Wahl der Rechtsform entscheidet über drei Dinge: wer für Schulden haftet, wie viel Kapital eingebracht werden muss und welche Formalitäten bei Gründung und Buchführung anfallen.[^1]

| Rechtsform | Gesellschafter | Haftung | Mindestkapital | Register |
|---|---|---|---|---|
| **Einzelunternehmen** | 1 | unbeschränkt, auch mit dem Privatvermögen | keins | Handelsregister A, sofern Kaufmann |
| **GbR** | ab 2 | unbeschränkt und gesamtschuldnerisch | keins | freiwillig im Gesellschaftsregister |
| **OHG** | ab 2 | unbeschränkt und gesamtschuldnerisch | keins | Handelsregister A |
| **KG** | ab 2 | Komplementär unbeschränkt, Kommanditist nur mit seiner Einlage | keins | Handelsregister A |
| **GmbH** | ab 1 | beschränkt auf das Gesellschaftsvermögen | 25.000 €, davon mindestens 12.500 € eingezahlt | Handelsregister B |
...
Welche Marktform vorliegt, ergibt sich aus der Zahl der Anbieter und der Zahl der Nachfrager.[^3]

| Nachfrager ↓ / Anbieter → | einer | wenige | viele |
|---|---|---|---|
| **einer** | zweiseitiges Monopol | beschränktes Nachfragemonopol | Nachfragemonopol |
| **wenige** | beschränktes Angebotsmonopol | zweiseitiges Oligopol | Nachfrageoligopol |
...
| Ab | Was gilt |
|---|---|
| 1. Januar 2025 | **Jedes** Unternehmen muss E-Rechnungen empfangen und verarbeiten können. Eine E-Mail-Adresse genügt dafür rechtlich. |
...
Für Anwendungsentwickler ist das kein Verwaltungsthema: Wer eine Warenwirtschaft oder einen Shop betreut, muss die Ausgabe auf ein strukturiertes Format umstellen und die Rechnungen revisionssicher aufbewahren.
...
[^3]: <https://de.wikipedia.org/wiki/Marktform>
