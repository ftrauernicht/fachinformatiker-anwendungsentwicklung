...
<img title="Docker Architecture" src="../assets/img/docker/architecture.svg" alt="Docker Architecture"><br>
[^8]

### Basics

Docker is based on Linux techniques such as **Cgroups** and **Namespaces** to realize containers. While initially the LXC interface of the Linux kernel was used, the Docker developers have since developed their own programming interface called **libcontainer**, which is also available to other projects.
<br>

Normally, Docker is oriented towards virtualization with Linux, but it can also be used on Windows or macOS using **HyperV**, **VirtualBox**, **HyperKit**, or **VirtualBox**.
