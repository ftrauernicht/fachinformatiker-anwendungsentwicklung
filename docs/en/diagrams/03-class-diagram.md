...
<img title="Class Diagram" src="../../assets/img/uml-class-diagram/class-notation.png" alt="Class Diagram">
<br>
...
<br>
<img title="Association" src="../../assets/img/uml-class-diagram/relations/association.png" alt="Association">
<br>
...
- **Inheritance** is also called **Generalization** and is used to describe the relationship between parent and child classes. A parent class is also referred to as a base class, and a subclass is also referred to as a derived class.
...
<br>
<img title="Inheritance" src="../../assets/img/uml-class-diagram/relations/inheritance.png" alt="Inheritance">
<br>

#### Realization / Implementation

- **Implementation** is mainly used to specify the relationship between interfaces and implementation classes.
...
<br>
<img title="Realization-Implementation" src="../../assets/img/uml-class-diagram/relations/realization.png" alt="Realization-Implementation">
<br>
...
<br>
<img title="Dependency" src="../../assets/img/uml-class-diagram/relations/dependency.png" alt="Dependency">
<br>
...
<br>
<img title="Composition" src="../../assets/img/uml-class-diagram/relations/composition.png" alt="Composition">
